...
export const LoginAction=(userdetails)=>(dispatch,getState)=>{ 
  ...
  export const SeatSelected=(userselected)=>(dispatch,getState)=>{
    ...
    const {bookmyshow:{userSelected}} = getState();
    
    const seat = userSelected.find((checkedSeats)=> checkedSeats===userselected)
...
if(!userselected){
    ...
    dispatch({
        ...
        payload: []
                ...
                const seats = userSelected.filter((checkedSeats)=> checkedSeats!==userselected)
